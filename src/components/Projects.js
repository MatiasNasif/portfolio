    ...
    <div className="projects-container">
      <div className="individual-project">
        <div className="information-container">
          <h3>Fast Delivery</h3>
          <p>
            Desarrollé una aplicación que es una plataforma de gestión de
            entregas que permite a los repartidores seleccionar y entregar hasta
            10 paquetes al día. La empresa puede utilizar la aplicación para
            hacer seguimiento y gestión de sus repartidores y entregas, junto a
            un equipo de 3 personas en 3 meses. Tecnologías. Github Actions ·
      ...
      <div className="individual-project">
        <div className="information-container">
          ...
          <p>
            ...
            equipo de 2 personas en 5 meses. Utilizamos metodologías ágiles y
            las siguientes tecnologías. React.js • JavaScript • DonWeb • Docker
      ...
      <div className="individual-project">
        <div className="information-container">
          <h3>Hornero App</h3>
          <p>
            Desarrollé una aplicación móvil junto con un equipo de 5 personas
            como práctica profesional en Globant. Implementamos metodologías
            ágiles y accesibilidad a un nivel WCAG AA. Tecnologías. • React •
            Express • MongoDB • NodeJS • Redux • JavaScript • Sequelize•js •
            React Hooks
          </p>
          <a
